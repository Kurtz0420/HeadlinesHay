...
//
//class HeadlinesPagerAdapter extends PagerAdapter {
//
...
//
//    public HeadlinesPagerAdapter(Context context, SharedPreferences sharedPreferences, List<Announcement> announcementList) {
